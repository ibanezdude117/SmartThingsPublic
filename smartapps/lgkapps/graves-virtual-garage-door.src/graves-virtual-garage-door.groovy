...
definition(
    name: "Graves Virtual Garage Door",
    namespace: "lgkapps",
    author: "ibenezdude@yahoo.com",
...
preferences {
    ...
    section("Timeout before checking if the door opened or closed correctly?"){
        input "checkTimeout", "number", title: "Door Operation Check Timeout?", required: true, defaultValue: 20
    }
